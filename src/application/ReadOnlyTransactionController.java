...
public class ReadOnlyTransactionController implements Initializable, DataAccessLayer {
	...
	public void switchBackToAccountReportScene(ActionEvent event) throws IOException {
		FXMLLoader loader = new FXMLLoader(getClass().getResource("AccountReportScene.fxml"));
